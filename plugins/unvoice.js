...
if (Config.WORKTYPE == 'private') {
    ...
    King.applyCMD({pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC,  deleteCommand: false}, (async (message, match) => {    
    ...
    King.applyCMD({pattern: 'unvoice', fromMe: false, desc: Lang.UV_DESC}, (async (message, match) => {    
