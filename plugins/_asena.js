...
const Lang = Language.getString('_king');
...
if (Config.WORKTYPE == 'private') {
    ...
    King.addCommand({pattern: 'king ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
