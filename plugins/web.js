...
King.applyCMD({pattern: 'speedtest', fromMe: true, desc: Lang.SPEEDTEST_DESC,  deleteCommand: false}, (async (message, match) => {
...
King.applyCMD({pattern: 'ping', fromMe: true, deleteCommand: false, desc: Lang.PING_DESC}, (async (message, match) => {
...
King.applyCMD({pattern: 'short ?(.*)', fromMe: false, desc: Lang.URL}, (async (message, match) => {
