...
if (Config.WORKTYPE == 'private') {
    ...
    King.applyCMD({pattern: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC,  deleteCommand: false}, (async (message, match) => {
    ...
    King.applyCMD({pattern: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC}, (async (message, match) => {
