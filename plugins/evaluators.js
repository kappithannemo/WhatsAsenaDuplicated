...
if (Config.LANG == 'SI') dd = 'සේවාදායකයේ ගොනුවේ ඇතුලත මුද්‍රණය කරන්න.', errmsg = '*ඔබ සොයන ගොනුව සේවාදායකයේ නොමැත!*'
...
if (Config.LANG == 'SI') bdesc = 'සේවාදායකය තුළ ශ්‍රව්‍ය, දෘශ්‍ය හා ඡායාරූප යවයි.', berr = '*ඔබ සොයන ගොනුව සේවාදායකයේ නොමැත!*', need_way = '*ගොනු මාර්ගය අවශ්‍යයි!*'
...
if (Config.LANG == 'SI') addsdesc = 'රූපය, ශ්‍රව්‍ය හෝ වීඩියෝ පටය සේවාදායකයට උඩුගත කරයි.', rep_add = '*ඕනෑම මාධ්‍ය පණිවිඩයකට පිළිතුරු දෙන්න!*', suc_add = '*සේවාදායකයට මාධ්‍ය එකතු කරන ලදි!  ✅*'
...
if (Config.LANG == 'SI') ldc = '*සම්බන්ධකය අනාවරණය විය!*'
...
if (Config.LANG == 'SI') medinfo = 'පිළිතුරු දුන් වීඩියෝ පටයේ තාක්ෂණික තොරතුරු පෙන්වයි.'
...
if (Config.LANG == 'SI') sucmsg = '*පණිවිඩය සාර්ථකව යවන ලදි ✅*', pmmm = 'පිළිතුරු දුන් පුද්ගලයාට පෞද්ගලික පණිවිඩයක් යවයි.', psmm = 'වගඋත්තරකරුට පෞද්ගලික හ voice පණිවිඩයක් යවයි.'
